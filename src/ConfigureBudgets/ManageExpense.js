  ...
  return (
    <main className="center" id="main" aria-label="main">
      <div style={{ width: '300px', margin: 'auto', backgroundColor: '#f9f9f9', border: '1px solid #ccc', borderRadius: '5px', padding: '20px' }}>
        ...
        <button onClick={handleAddExpense} style={{ backgroundColor: '#4caf50', color: 'white', padding: '10px 15px', border: 'none', borderRadius: '5px', cursor: 'pointer', width: '100%', marginBottom: '15px' }}>Add Expense</button>
  
        <button type="button" onClick={handleBack} style={{ width: '100%', cursor: 'pointer' }}>
          Back
        </button>
      </div>
    </main>
