  ...
  return (
    <main className="center" id="main" aria-label="main">
      <div style={{ width: '450px', margin: 'auto', backgroundColor: '#f9f9f9', border: '1px solid #ccc', borderRadius: '10px', padding: '20px' }}>
        ...
        <button type="button" onClick={handleAddBudget} style={{ backgroundColor: '#4caf50', color: 'white', padding: '10px 15px', border: 'none', borderRadius: '5px', cursor: 'pointer', width: '100%' }}>
          Add Budget
        </button>
        ...
        <button type="button" onClick={handleSaveBudgets} style={{ backgroundColor: '#4caf50', color: 'white', padding: '10px 15px', border: 'none', borderRadius: '5px', cursor: 'pointer', width: '48%', marginRight: '10px' }}>
          Save The Entered Budget
        </button>
        
        <button type="button" onClick={handleBack} style={{ width: '48%', cursor: 'pointer' }}>
          Go Back
        </button>
      </div>
    </main>
